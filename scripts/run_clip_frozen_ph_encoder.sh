#!/usr/bin/env bash
#SBATCH --job-name=train-simple-clip-frozen-ph
#SBATCH --nodes=1
...
#SBATCH --mem=512G
#SBATCH --time=1:00:00
#SBATCH --output=/mnt/ps/home/CORP/yassir.elmesbahi/project/unimodality_pipeline/out/train-simple-clip-frozen-ph.out
#SBATCH --error=/mnt/ps/home/CORP/yassir.elmesbahi/project/unimodality_pipeline/out/train-simple-clip-frozen-ph.out 
...
### General
export EXP_NAME="train-simple-clip-frozen-ph"
