#!/usr/bin/env bash
#SBATCH --job-name=augmented_clip_shake_42_1e-10
#SBATCH --nodes=1
...
#SBATCH --mem=512G
#SBATCH --time=5:00:00
#SBATCH --output=/mnt/ps/home/CORP/yassir.elmesbahi/project/unimodality_pipeline/out/augmented_clip_shake_42_1e-10.out
#SBATCH --error=/mnt/ps/home/CORP/yassir.elmesbahi/project/unimodality_pipeline/out/augmented_clip_shake_42_1e-10.out
...
declare -A PH_CLASSIFIER_LR_DIC=(
    ["clip"]=1e-7
    ["vicreg"]=1e-7
    ["sigclip"]=1e-7
    ["shake"]=1e-7
...
declare -A TX_CLASSIFIER_LR_DIC=(
    ["clip"]=1e-3
    ["vicreg"]=1e-3
    ["sigclip"]=1e-3
    ["shake"]=1e-3
...
export PRETRAINED_WEIGHTS='/mnt/ps/home/CORP/yassir.elmesbahi/project/unimodality_pipeline/data/save_ph_encoder/save_ph_encoder/epoch=03-val_loss=5.42-val_acc=0.00.ckpt'

### General
export SEED=42
export METHOD='shake'
export PH_CLASSIFIER_LR=${PH_CLASSIFIER_LR_DIC[$METHOD]}
export TX_CLASSIFIER_LR=${TX_CLASSIFIER_LR_DIC[$METHOD]}
export TX_ENCODER_LR=${TX_ENCODER_LR_DIC[$METHOD]}
export PH_ENCODER_LR=${PH_ENCODER_LR_DIC[$METHOD]}
export PH_CLASSIFIER_LR=1e-10
...
export RUNNER_ARGS=" \
    ...
    --tx_classifier_lr ${TX_CLASSIFIER_LR} \
